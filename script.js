...
const revealElements = document.querySelectorAll('.about-text, .skills-grid, .projects-grid, .contact-content');
...
// Particle background for hero section (optional enhancement)
